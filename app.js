...
// FOR BONUS INSIDE OF THE FUNCTION (IF ELSE) HAVE BEEN WORKING

const getImages = (query) => {
  
 if(query==""){
      document.getElementById("displayHold").style.display="block";
 }
 else {
  toggleSpinner(true);
...
const createSlider = () => {
  ...
  sliders.forEach(slide => {
    ...
    document.getElementById("displayHold").style.display="none";
}
...
sliderBtn.addEventListener('click', function () {
  ...
  if(duration <= 0){
    ...
    alert('Please give the slider time duration without minus digit');
  }
  else {
    createSlider();   
  }
